...
<table class='table table-striped'>
    ...
    @foreach ($cursos as $dados)
        <tr>
            ...
            <td>
                <a href="{{ action('CursoController@editar', $dados->id) }}"><span class='glyphicon glyphicon-pencil'></span></a>
                &nbsp;
                <a href="{{ action('CursoController@remover', $dados->id) }}"><span class='glyphicon glyphicon-remove'></span></a>
            </td>
