...
<table class='table table-striped'>
    ...
    @foreach ($turmas as $dados)
        <tr>
            ...
            <td>
                <a href="{{ action('TurmaController@editar', $dados->id) }}"><span class='glyphicon glyphicon-pencil'></span></a>
                &nbsp;
                <a href="{{ action('TurmaController@remover', $dados->id) }}"><span class='glyphicon glyphicon-remove'></span></a>
            </td>
    @endforeach
    </tbody>
</table>
